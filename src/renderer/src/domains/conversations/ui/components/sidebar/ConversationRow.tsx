...
export function ConversationRow({ conversation, activity, isPinned, onOpen, onTogglePin }: ConversationRowProps) {
  return (
    <div className="group flex items-center gap-1 rounded py-1 pr-1 pl-4 hover:bg-edge focus-within:bg-edge">
      ...
      <button
        type="button"
        className={`px-1 text-[11px] ${isPinned ? 'text-amber-300' : 'text-muted opacity-0 group-hover:opacity-100 focus:opacity-100'}`}
